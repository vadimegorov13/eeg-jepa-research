...
=======
  --configs src/utils/experiments/configs/liu2024_hpgrid_537_demean_none_part1.json \
>>>>>>> Stashed changes
=======
  --configs src/utils/experiments/configs/liu2024_twfb_short153_timing_sweep.json \
>>>>>>> origin/main
  --kernel-name eeg-jepa \
  --daemon
```
